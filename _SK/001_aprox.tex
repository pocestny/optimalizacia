...
\begin{framed}
  \begin{dfn}
    ...
    $v_1,\ldots,v_n$ (pričom ceny aj objemy sú prirodzené čísla).  Takisto
    je dané prirodzené číslo $B$, ktoré reprezentuje veľkosť batoha. Cieľom
    prolému \Qknapsack je nájsť racionálne čísla  $\alpha_1,\ldots,\alpha_n$ tak, aby
...
$W_1$ je totiž optimálna hodnota pre podporoblém daného vstupu a preto je 
...
keďže $h\ge k$, existuje aspoň $k+1$ prvkov veľkosti aspoň $x_h$. Lenže $2L$ je súče všetkých prvkov, preto
$2L\ge x_h(k+1)$.
