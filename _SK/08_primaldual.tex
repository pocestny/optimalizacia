...
Keď sa v ďalšom kroku bude voľným bublinám pridávať náboj $+\varepsilon$, bublinám z alternujúcej cesty
sa bude striedavo pridávať $+\varepsilon$ a $-\varepsilon$, aby sa žiadna hrana nepreplnila (pripomíname,
že na rozdiel od zelených bublín, modré bubliny môžu mať záporný náboj). V ďalšom kroku sa naplní hrana
...
$Z$ budú všetci synovia zahrnutých kvetov -- títo ostanú na nepárnej úrovni. \FIXME{aku hodnotu bude mat nova bublina?}
...
\noindent
  ...
  \FIXME{co znamena do seba vnorenych bublin? neviem mat bublinu hlbky 2 iba z 3 vrcholov (bublina hlbky 1 a 2 vrcholy) co by mi davalo n/(1+2h) kvetov hlbky h}
